...
import copy  # 🚨 [추가] 원본 DB 오염 방지를 위한 모듈
...
NAPEUM_RICH_DESC = {
    ...
    "ja": {
        "해중금": "海の底に沈んだ宝石。表に現れない深い内功と無限の潜在力を持っています。",
        "노중화": "炉の中で燃え上がる炎。暖かく保護された環境でひそかな粘り強さと知性を発揮します。",
        "대림목": "鬱蒼とした巨大な森。スケールが大きく数多くの生命を抱く雄大な包容力を意味します。",
        "대림토": "鬱蒼とした巨大な森（大林木）。スケールが大きく数多くの生命を抱く雄大な包容力を意味します。",
        "노방토": "人々が踏みしめていく道端の土。自己犠牲の精神が強く、親和性に優れ大衆とよく調和します。",
        "검봉금": "鋭く研がれた名剣。不正を許さない鋭い決断力と強力なカリスマを発揮します。",
        "산두화": "山頂で燃え上がる松明。遠くからも光を放ち人々を導く先駆者的な気質があります。",
        "간하수": "山谷を流れる澄んだ小川。穏やかながらも立ち止まらない生命力と清らかで純粋な魂を持っています。",
        "성두토": "城壁を成す固い土。外部の敵を防ぐ強固な責任感と揺るぎない原則を象徴します。",
        "백랍금": "蝋のようには固まる柔らかい金。柔軟性と融通性に優れ、環境に合わせて自らを磨き上げます。",
        "백납금": "蝋のようには固まる柔らかい金。柔軟性と融通性に優れ、環境に合わせて自らを磨き上げます。",
        "양류목": "水辺に咲き乱れる柳。柔らかく柔軟で、強い風にも折れない処世術に優れています。",
        "천중수": "地中深くに湧き出る泉。枯れることのない知恵と他人に施す純粋な慈悲心があります。",
        "옥상토": "屋根の上に覆われた瓦/土。外部の風波から人々を保護し、高いところから世界を見下ろします。",
        "벽력화": "闇を切り裂く雷妻。瞬間的に爆発する天才性と誰にも真似できない独創性を持っています。",
        "송백목": "真冬にも青い松と柏。いかなる試練の中でも屈しない志と厳しい節操があります。",
        "장류수": "絶えず流れていく長い川。立ち止まらない挑戦精神と巨大な勢力を形成し海へ進む気象です。",
        "사중금": "砂の中に埋もれた砂金。長い時間磨かれ発見されるのを待つ貴く繊細な価値です。",
        "산하화": "山の麓で燃え上がる夕焼け/炎。ほのかでありながらも世界を美しく染める芸術的感覚が際立ちます。",
        "평지목": "平野に育った木。平坦な環境の中で安定して成長し、無難で健実な生活を追求します。",
        "벽상토": "家を支える壁の土。見かけは平凡ですが人々の安息処を支える見えない頼もしい協力者です。",
        "금박금": "仏像に塗る薄い金箔。華やかで荘厳な魅力で他人を引き立てる特殊で輝く才能です。",
        "복등화": "闇を照らす灯火。孤独で寂しい人々に希望を与える暖かく献身的な宗教的/哲学的気運です。",
        "천하수": "天から降る天の川/雨。万物を潤し命を与える清らかで高潔な魂と純粋さがあります。",
        "대역토": "広い荒野と駅馬の土。スケールが膨大で複数の地域を網羅する受容力と貿易/流通の気運を意味します。",
        "차천금": "女性を装飾する簪と腕輪。洗練された繊細な美的感覚と貴族的に華やかな品格を象徴します。",
        "상자목": "絹を織る蚕を飼う桑の木。他人のために有用な価値を創出し犠牲によって大きな業績を成し遂げます。",
        "대계수": "深い山に集まり流れる渓谷の水。清らかで冷たい知性で万物の渇きを癒す学者的気質があります。",
        "사중토": "砂と混ざった土。風雨に耐え、自分だけの堅固な基盤を築き上げる強靭で荒々しい粘り強さがあります。",
        "천상화": "天の真ん中に浮かぶ太陽。天下を公平に照らし万物を育む圧倒的なスケールと公明正大さを持っています。",
        "석류목": "秋に硬く熟したザクロの木。華やかさの中にぎっしり詰まった結実を抱き、財物と子孫の繁栄を象徴します。",
        "대해수": "全てを飲み込む巨大な海。底知れぬ深い知恵とすべての善悪を包み込む圧倒的な受容力があります。"
    },
    "zh-CN": {
        "해중금": "沉落深海的宝石。拥有不露锋芒的深厚内功与无限潜力。",
        "노중화": "炉中燃烧的火焰。在温暖受保护的环境中发挥隐忍的毅力与智慧。",
        "대림목": "郁郁葱葱的巨大森林。格局宏大，象征孕育无数生命的雄伟包容力。",
        "대림토": "郁郁葱葱的巨大森林(大林木)。格局宏大，象征孕育无数生命的雄伟包容力。",
        "노방토": "任人践踏的路边泥土。牺牲精神强，极具亲和力，能与大众打成一片。",
        "검봉금": "削铁如泥的名剑。拥有对不义零容忍的锐利决断力与强大的领袖气质。",
        "산두화": "山顶燃烧的火炬。光芒远照，具备指引众人的先驱者气质。",
        "간하수": "流淌于山谷的清澈溪流。拥有波澜不惊却生生不息的生命力与纯洁的灵魂。",
        "성두토": "构筑城墙的坚实泥土。象征抵御外敌的坚定责任感与不可动摇的原则。",
        "백랍금": "如蜡般凝固的软金。极具柔软性与变通力，能顺应环境磨练自身。",
        "백납금": "如蜡般凝固的软金。极具柔软性与变通力，能顺应环境磨练自身。",
        "양류목": "水边摇曳的杨柳。柔软灵活，深谙狂风亦折不断的处世之道。",
        "천중수": "涌自地下深处的泉水。拥有取之不尽的智慧与施惠于人的纯粹慈悲心。",
        "옥상토": "覆盖屋顶的瓦片/泥土。遮挡外界风雨保护众人，居高临下俯瞰世间。",
        "벽력화": "划破黑暗的雷电。拥有瞬间爆发的天才性与无人能及的独创性。",
        "송백목": "严冬依然常青的松柏。在任何考验中都绝不屈服，拥有严寒般坚贞的节操。",
        "장류수": "奔流不息的长河。拥有永不止步的挑战精神，形成浩大声势奔向大海的气象。",
        "사중금": "埋藏沙中的沙金。历经岁月打磨，等待被发掘的珍贵且细腻的价值。",
        "산하화": "山脚燃烧的晚霞/火焰。光芒柔和却能绝美地染红世界，极具艺术感。",
        "평지목": "生长于平原的树木。在平坦的环境中稳定成长，追求平安稳健的生活。",
        "벽상토": "支撑房屋的墙壁之土。看似平凡，却是默默支撑他人安息之地的坚实后盾。",
        "금박금": "为佛像镀上的薄金箔。以华丽庄严的魅力衬托他人，是特殊而耀眼的才能。",
        "복등화": "照亮黑暗的灯盏。为孤独寂寞之人带来希望，充满温暖与奉献的宗教/哲学气息。",
        "천하수": "天上降下的银河/雨水。拥有滋润万物、赋予生命的清纯高洁灵魂。",
        "대역토": "广阔的原野与驿马之土。格局庞大，象征跨越地域的包容力与贸易/流通的气运。",
        "차천금": "装饰女子的发簪与手镯。象征洗练细腻的审美与贵族般华丽的品格。",
        "상자목": "养蚕织绸的桑树。为他人创造实用价值，通过牺牲铸就伟大业绩。",
        "대계수": "深山汇聚的溪谷之水。以清冽的理智解除万物之渴，极具学者气质。",
        "사중토": "混杂沙石的泥土。经受风吹雨打，开辟属于自己坚固地盘的强悍毅力。",
        "천상화": "悬于天顶的太阳。拥有公平普照天下、孕育万物的压倒性格局与大公无私。",
        "석류목": "秋日结满硬实果实的石榴树。在华丽中孕育着丰硕的果实，象征财富与子孙繁盛。",
        "대해수": "吞噬一切的汪洋大海。拥有深不可测的智慧与包容所有善恶的压倒性度量。"
    },
    "zh-TW": {
        "해중금": "沉落深海的寶石。擁有不露鋒芒的深厚內功與無限潛力。",
        "노중화": "爐中燃燒的火焰。在溫暖受保護的環境中發揮隱忍的毅力與智慧。",
        "대림목": "鬱鬱蔥蔥的巨大森林。格局宏大，象徵孕育無數生命的雄偉包容力。",
        "대림토": "鬱鬱蔥蔥的巨大森林(大林木)。格局宏大，象徵孕育無數生命的雄偉包容力。",
        "노방토": "任人踐踏的路邊泥土。犧牲精神強，極具親和力，能與大眾打成一片。",
        "검봉금": "削鐵如泥的名劍。擁有對不義零容忍的銳利決斷力與強大的領袖氣質。",
        "산두화": "山頂燃燒的火炬。光芒遠照，具備指引眾人的先驅者氣質。",
        "간하수": "流淌於山谷的清澈溪流。擁有波瀾不驚卻生生不息的生命力與純潔的靈魂。",
        "성두토": "構築城牆的堅實泥土。象徵抵禦外敵的堅定責任感與不可動搖的原則。",
        "백랍금": "如蠟般凝固的軟金。極具柔軟性與變通力，能順應環境磨練自身。",
        "백납금": "如蠟般凝固的軟金。極具柔軟性與變通力，能順應環境磨練自身。",
        "양류목": "水邊搖曳的楊柳。柔軟靈活，深諳狂風亦折不斷的處世之道。",
        "천중수": "湧自地下深處的泉水。擁有取之不盡的智慧與施惠於人的純粹慈悲心。",
        "옥상토": "覆蓋屋頂的瓦片/泥土。遮擋外界風雨保護眾人，居高臨下俯瞰世間。",
        "벽력화": "劃破黑暗的雷電。擁有瞬間爆發的天才性與無人能及的獨創性。",
        "송백목": "嚴冬依然常青的松柏。在任何考驗中都絕不屈服，擁有嚴寒般堅貞的節操。",
        "장류수": "奔流不息的長河。擁有永不止步的挑戰精神，形成浩大聲勢奔向大海的氣象。",
        "사중금": "埋藏沙中的沙金。歷經歲月打磨，等待被發掘的珍貴且細膩的價值。",
        "산하화": "山腳燃燒的晚霞/火焰。光芒柔和卻能絕美地染紅世界，極具藝術感。",
        "평지목": "生長於平原的樹木。在平坦的環境中穩定成長，追求平安穩健的生活。",
        "벽상토": "支撐房屋的牆壁之土。看似平凡，卻是默默支撐他人安息之地的堅實後盾。",
        "금박금": "為佛像鍍上的薄金箔。以華麗莊嚴的魅力襯托他人，是特殊而耀眼的才能。",
        "복등화": "照亮黑暗的燈盞。為孤獨寂寞之人帶來希望，充滿溫暖與奉獻的宗教/哲學氣息。",
        "천하수": "天上降下的銀河/雨水。擁有滋潤萬物、賦予生命的清純高潔靈魂。",
        "대역토": "廣闊的原野與驛馬之土。格局龐大，象徵跨越地域的包容力與貿易/流通的氣運。",
        "차천금": "裝飾女子的髮簪與手鐲。象徵洗練細膩的審美與貴族般華麗的品格。",
        "상자목": "養蠶織綢的桑樹。為他人創造實用價值，通過犧牲鑄就偉大業績。",
        "대계수": "深山匯聚的溪谷之水。以清冽的理智解除萬物之渴，極具學者氣質。",
        "사중토": "混雜沙石的泥土。經受風吹雨打，開闢屬於自己堅固地盤的強悍毅力。",
        "천상화": "懸於天頂的太陽。擁有公平普照天下、孕育萬物的壓倒性格局與大公無私。",
        "석류목": "秋日結滿硬實果實的石榴樹。在華麗中孕育著豐碩的果實，象徵財富與子孫繁盛。",
        "대해수": "吞噬一切的汪洋大海。擁有深不可測的智慧與包容所有善惡的壓倒性度量。"
    }
}
...
GLOBAL_TERM_DB = {
    ...
    "편인": {"ja": "【直感と偏心】 偏った受容。鋭い直感力、特殊学問、疑い、孤独を意味します。", "zh-CN": "【直觉与偏心】 偏向的吸收。象征敏锐直觉、特殊学问、猜忌与孤独。", "zh-TW": "【直覺與偏心】 偏向的吸收。象徵敏銳直覺、特殊學問、猜忌与孤獨。"},
...
def build_full_response(dt_kst, astro_res, gender, daewun_num=1, partner_info=None, apply_trad=False, lunar_m=None, unknown_time=False, lang="ko"):
    ...
    # 🚨 [수정 완수] 에러를 우회하고 딕셔너리를 깊은 복사하는 안전장치
...
async def bazi_endpoint(request: Request):
    try:
        ...
        # 🚨 여기서 연산 파라미터는 대표님의 오리지널 그대로 유지됩니다!
